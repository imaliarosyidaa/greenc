    ...
    >
      <div class="max-w-7xl mx-auto p-6 grid grid-cols-1 md:grid-cols-2 gap-24">
        ...
        <div>
          ...
          <p class="text-sm text-gray-500 mt-1">BJB Virtual Account</p>

          <h3 class="text-lg font-semibold text-gray-800 mt-6">Produk yang Dibeli</h3>
          <div class="mt-2 border-b pb-2">
            <div class="flex justify-between text-gray-600">
              <span>Tiket Masuk Keraton Kasepuhan Cirebon (UMUM)</span>
              <span>Rp. 10.000</span>
            </div>
            <div class="text-sm text-gray-500">1 x Rp. 10.000</div>
          </div>
        </div>
        ...
        <div>
          ...
          <p class="text-gray-600">16 Agu 2024, 10:00 WIB</p>
          ...
          <h3 class="text-lg font-semibold text-gray-800 mt-6">BJB Virtual Account</h3>
          <p class="text-gray-600">Nomor Virtual Account</p>
          <p class="text-xl font-semibold">8883xxxxxxxxxx</p>
          <p class="text-gray-600 mt-4">Total Pembayaran</p>
          <p class="text-2xl font-bold">Rp. 33.500</p>

          <button class="mt-6 w-full bg-[#DAA520] text-white py-3 rounded-lg">
            Upload Bukti Bayar
          </button>
          <button class="mt-4 w-full border border-yellow-500 text-yellow-600 py-3 rounded-lg">
            Cara Pembayaran
          </button>
        </div>
      </div>
